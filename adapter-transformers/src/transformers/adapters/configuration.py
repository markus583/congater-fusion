...
class ModelAdaptersConfig(Collection):
    ...
    def get_congosition_v1(
        self, fusion_name: Union[str, List[str]], grid_values=None
    ) -> Optional[dict]:
        """
        Gets the config dictionary for a given AdapterFusion.
...
@dataclass(eq=False)
class DynamicCongaterV5FusionConfigDoubleTTNDSigmoidTargetTanh(
    DynamicCongaterV5FusionConfig
):
    """
    Dynamic version of adapter fusion with a value matrix and regularization. See https://arxiv.org/pdf/2005.00247.pdf.
    """
...
@dataclass(eq=False)
class DynamicCongaterV5FusionConfigNDSigmoidTargetTanhValueInitAvg(
    DynamicCongaterV5FusionConfig
):
    """
    Dynamic version of adapter fusion with a value matrix and regularization. See https://arxiv.org/pdf/2005.00247.pdf.
...
@dataclass(eq=False)
class VectorConfig3AvgInitDropout03(CongositionV1Config):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "avg"
    omega_init_scale: float = 2.
...
@dataclass(eq=False)
class VectorConfigVal015InitDropout03(CongositionV1Config):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "value"
    omega_init_scale: float = 0.15
    dropout_ratio: float = 0.3
    
@dataclass(eq=False)
class VectorConfigVal02InitDropout03(CongositionV1Config):
    learn_omega: bool = True
    omega_shape: str = "vector"
    omega_init_type: str = "value"
    omega_init_scale: float = 0.2
    dropout_ratio: float = 0.3
...
CONGOSITIONV1_CONFIG_MAP = {
    ...
    "splitL__vector_3_avg_d03": VectorConfig3AvgInitDropout03(),
    "splitL__vector_avg_d03": VectorConfigAvgInitDropout03(),
    "splitL__vector_val015_d03": VectorConfigVal015InitDropout03(),
    "splitL__vector_val02_d03": VectorConfigVal02InitDropout03(),
...
for k, v in map_copy.items():
    CONGOSITIONV1_CONFIG_MAP[k + "-difflr_omega"] = v
    CONGOSITIONV1_CONFIG_MAP[k + "-difflr_beta"] = v
