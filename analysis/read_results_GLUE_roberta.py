...
OUT_FILES = [
    ...
    "st-a-splitL__vector_3_avg_d03-lr1e-2-GLUE.csv",
    "st-a-splitL__vector_avg_d03-lr1e-2-GLUE.csv",
    "st-a-splitL__vector_val015_d03-lr1e-2-GLUE.csv",
    "st-a-splitL__vector_val02_d03-lr1e-2-GLUE.csv",
    "st-a-splitL__vector_2_avg_d03-lr5e-3-GLUE.csv",
    "st-a-splitL__vector_val015_d03-lr5e-3-GLUE.csv",
    "st-a-splitL__vector_2_avg_d03-lr5e-3-cosine-GLUE.csv",
]
...
DIR_NAMES = [
    ...
    "st-a-splitL__vector_3_avg_d03-lr1e-2-GLUE",
    "st-a-splitL__vector_avg_d03-lr1e-2-GLUE",
    "st-a-splitL__vector_val015_d03-lr1e-2-GLUE",
    "st-a-splitL__vector_val02_d03-lr1e-2-GLUE",
    "st-a-splitL__vector_2_avg_d03-lr5e-3-GLUE",
    "st-a-splitL__vector_val015_d03-lr5e-3-GLUE",
    "st-a-splitL__vector_2_avg_d03-lr5e-3-cosine-GLUE",
]
