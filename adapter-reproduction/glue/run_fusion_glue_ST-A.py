...
def main():
    ...
    model.load_adapter("runs/st-a/rte/bert-base-uncased/0", config=PfeifferConfig(), with_head=False)
    model.load_adapter("runs/st-a/mrpc/bert-base-uncased/0", config=PfeifferConfig(), with_head=False)
    ...
    # model.load_adapter("argument/ukpsent@ukp", config=PfeifferConfig(), with_head=False)
